...
<html lang="en">
  ...
  <body id="page-top" data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="80" tabindex="0">
    ...
    <nav class="navbar navbar-expand-sm shadow-sm fixed-top" style="background-color: #AB9E7A; opacity: .9">
      <div class="container-fluid">
        ...
        <a class="navbar-brand text-white "> <span class="fw-semibold">ClAssign</span> <span class="fw-light small">For Education</span> </a>
        ...
        <div class="container">
          <div class="row text-center">
            <div class="col px-3 mx-auto" style="max-width: 900px">
              ...
              <p data-aos="zoom-in">ClAssign dikembangkan oleh tim mahasiswa yang peduli terhadap efisiensi dan kenyamanan dalam pendidikan digital. Misi kami adalah membantu pendidik dan siswa dalam menjalani proses pengajaran dan pembelajaran yang lebih terorganisir, menyenangkan, dan produktif.</p>
            </div>
          </div>
        </div>
      </section>
  ...
  <script>
    // Hilangkan fungsi setRoleAndRedirect lama
  </script>
</html>
